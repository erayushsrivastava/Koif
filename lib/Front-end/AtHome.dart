    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Text(
            'Welcome to home services section, where you can book a freelance barber for grooming at your place.',
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    //icon: Icon(Icons.arrow_right_alt, color: Colors.white), // Forward arrow icon
