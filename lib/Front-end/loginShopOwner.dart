...
import 'package:koif/Front-end/shopOwnerDashboard.dart'; // Import the ShopOwnerDashboard
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Continue with Google Button (Image instead of Icon)
            SizedBox(
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  // Navigate to ShopOwnerDashboard when the "Continue with Phone" button is pressed
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => ShopOwnerDashboard()),
                  );
