...
const USER_POOL_ID = process.env.FREELANCER_USER_POOL_ID;
const CLIENT_ID = process.env.FREELANCER_CLIENT_ID;
  ...
  router.post('/signin', async (req, res) => {
    try {
      ...
      res.json({
        ...
        user: {
          username: attributes['name'],  // You can use the attribute that stores the username
